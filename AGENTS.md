# Active approved plan — Phase 6 source and Preview schema complete

The owner authorized Phase 6 and GitHub publication and delegated Preview credential retrieval and encrypted backup choices; read docs/decisions/2026-09-23-phase-6-execution.md. The canonical master is docs/redesign/RivyaLivingArt-Commercial-Implementation-Plan.md revision 3.6. Read PHASE-6-ORDER-HANDOFF.md, phase-6-preview-migration.json and IMPLEMENTATION_PROGRESS.md in docs/redesign; retain Phase 2 contracts/runbook as integration authority, with Phase 6 receipts superseding their dated masked-credential/unapplied-migration state.

P6.1–P6.8 source is complete: product/bespoke v2 atomic save, saved-snapshot message finalization, private reference identity, receipt and Studio recovery. The Phase 2 contract and Phase 6 upload-identity migrations ARE APPLIED to isolated Preview; never replay blindly. Independent encrypted backup exists outside repo/provider; original data preserved. Both order write flags remain off. No inquiry, reference upload, seed, content publication or production change occurred. Application QA remains Phase 11.

Next is P7.1: complete Studio detail and immutable original versus operational amendment separation. Branch codex/phase-6-order-handoff includes Phase 5 final 44245c4b21405cd09c2986704accc3dd5dda4f1e. Main advanced during this phase to c7c5cb9161b961fe0e0c46c40d6b467d6a0252e7 (Phase 5 PR #19); the work branch fast-forwarded to that merge without source changes before publication. Verify fresh refs and publication receipt. Preserve every draft, record, identifier, private reference and approved asset.

WhatsApp is only saved-order Open/Copy with customer manual Send. No generic WhatsApp, payment/cart/customer accounts or Netlify. Vercel-only/free-only commercial eligibility and automatic-deployment hold remain. Environment-specific staff credentials, least-privilege runtime grants, backup portability/full restore, privacy and final QA remain release gates. Main/eligible production release is Phase 12. Do not ask again for plan approval or the already retrieved Preview secrets.
