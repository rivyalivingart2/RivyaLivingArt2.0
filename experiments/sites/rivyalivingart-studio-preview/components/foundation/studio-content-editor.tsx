...
import { PageSectionComposer } from "@/components/foundation/content-section-editor";
import { MediaAssetFigure } from "@/components/foundation/studio-media-figure";
import { MediaPicker } from "@/components/foundation/studio-media-picker";
import { TestimonialQuote } from "@/components/foundation/testimonial";
import { contentKindLabels, type ContentDocument, type ContentDocumentSummary, type ContentReferences } from "@/lib/rivya/source/content-contracts";
import { contentDifferences, type LocalContentCheckpoint } from "@/lib/rivya/source/content-history";
import { richTextToPlainText, textToRichText } from "@/lib/rivya/source/content-richtext";
import { faqGroups } from "@/lib/rivya/source/faqs";
import { validateContentDocument } from "@/lib/rivya/source/studio-content-validation";
import styles from "./studio-content.module.css";

const RichTextEditor = dynamic(() => import("@/components/foundation/content-richtext-editor").then((module) => module.RichTextEditor), { loading: () => <p className={styles.note}>Preparing the local text editor…</p> });
const subscribe = () => () => {};
