import {materialOptions,type Concept,type FurnitureCategory,type MemoryCategory,type PersonalCategory} from '@/lib/rivya/source/catalogue';
import {validateStudioProductDraft,type StudioProductDraft} from '@/lib/rivya/source/studio-product-draft';
