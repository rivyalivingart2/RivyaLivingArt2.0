...
export type StudioOrder = {id: string; client: string; title: string; status: OrderStage; version: number; updatedAt: string; reference?:string;assignee?:string|null;followUp?:string|null;source?:'website'|'manual'};
