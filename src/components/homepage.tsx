...
export function Homepage() {
  ...
  return <main id="main-content">
    ...
    <section id="commission" className="section commission" aria-labelledby="commission-title">
      ...
      <div><p>A table for a gathering place. An object with personal meaning. A direction that begins with you.</p><ol className={styles.briefSteps}><li><strong>The room & the role</strong><span>Where the piece will live, how it will be used and the dimensions you have in mind.</span></li><li><strong>A material direction</strong><span>The grain, colour, form or finish that draws you in. A concept is a conversation starter.</span></li><li><strong>The practical details</strong><span>Location, delivery access and your preferred timeline help shape a considered brief.</span></li></ol><div className="development-note"><strong>Enquiry flow is in development.</strong><span>This preview does not send WhatsApp messages or collect personal information. Explore the studies while the commission enquiry is being prepared.</span></div></div>
    </section>
  </main>;
}
