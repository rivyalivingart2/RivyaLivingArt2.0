...
export function SiteFooter() {
  if (isVisualPreviewAllowed(process.env)) return <footer className={styles.footer}>
    ...
    <div className={styles.meta}><p>Development preview · Fictional concepts and owner-review editorial drafts.</p><Link href="/studio">Studio development status <span aria-hidden="true">↗</span></Link></div>
  </footer>;
